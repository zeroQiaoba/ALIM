...
def load_cifar100(args):
    ...
    temp_train = torchvision.datasets.CIFAR100(root=args.dataset_root, train=True, download=True)
    ...
    temp_test = torchvision.datasets.CIFAR100(root=args.dataset_root, train=False, download=True)
